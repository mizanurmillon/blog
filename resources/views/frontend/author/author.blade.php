	...
	<div class="main-wrapper">
		...
		<nav class="sidebar">
            <div class="sidebar-header">
                <a href="{{ route('author.dashboard') }}" class="sidebar-brand">
                Noble<span>UI</span>
                </a>
							...
							<div class="dropdown-menu" aria-labelledby="profileDropdown">
								<div class="dropdown-header d-flex flex-column align-items-center">
									...
									<div class="text-center info">
										<p class="mb-0 name font-weight-bold">{{ Auth::guard('author')->user()->name }}</p>
										<p class="mb-3 email text-muted">{{ Auth::guard('author')->user()->email }}</p>
									</div>
								</div>
								<div class="dropdown-body">
